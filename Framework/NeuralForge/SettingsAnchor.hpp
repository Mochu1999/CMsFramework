...
//This is just a placeholder from offshore

//struct SettingsOffshore
//{
//	std::string settingsPath = "Resources/Settings/SettingsOffshore.bin";
//
//	p3& cameraPos;
//	p3& forward;
...
//	};
//
//	SettingsOffshore(Camera& camera, GlobalVariables& gv)
